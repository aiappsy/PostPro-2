    ...
    >
        <form class="flex flex-col gap-5" @submit.prevent="submit">
            <div class="grid gap-2">
                ...
                <InputMessage :message="form.errors.brand_website" />
            </div>
            ...
            <div class="grid gap-2">
                ...
                />
                <InputMessage :message="form.errors.name" />
            </div>
            ...
            <div class="grid gap-2">
                ...
                <Textarea
                    ...
                    rows="3"
                />
                <InputMessage :message="form.errors.brand_description" />
            </div>
            ...
            <div class="grid gap-4 sm:grid-cols-2">
                <div class="grid gap-2">
                    ...
                    <InputMessage :message="form.errors.brand_tone" />
                </div>
                ...
                <div class="grid gap-2">
                    ...
                    <InputMessage :message="form.errors.content_language" />
                </div>
            </div>
            ...
            <div class="grid gap-4 sm:grid-cols-3">
                <div class="grid gap-2">
                    ...
                    <InputMessage :message="form.errors.brand_color" />
                </div>
                <div class="grid gap-2">
                    ...
                    <InputMessage :message="form.errors.background_color" />
                </div>
                <div class="grid gap-2">
                    ...
                    <InputMessage :message="form.errors.text_color" />
                </div>
            </div>
            ...
            <div class="grid gap-2">
                ...
                <Textarea
                    ...
                    rows="3"
                />
                <InputMessage :message="form.errors.brand_voice_notes" />
            </div>
