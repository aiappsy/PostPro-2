    ...
    <div class="flex flex-col space-y-6">
        ...
        >
            ...
            <div class="grid gap-2">
                ...
                />
                <InputMessage :message="errors.brand_website" />
            </div>
            ...
            <div class="grid gap-2">
                ...
                <Textarea
                    ...
                    rows="3"
                />
                <InputMessage :message="errors.brand_description" />
            </div>
            ...
            <div class="grid gap-4 sm:grid-cols-2">
                <div class="grid gap-2">
                    ...
                    <InputMessage :message="errors.brand_tone" />
                </div>
                ...
                <div class="grid gap-2">
                    ...
                    />
                    <InputMessage :message="errors.content_language" />
                </div>
            </div>
            ...
            <div class="grid gap-4 sm:grid-cols-3">
                <div class="grid gap-2">
                    ...
                    <InputMessage :message="errors.brand_color" />
                </div>
                <div class="grid gap-2">
                    ...
                    />
                    <InputMessage :message="errors.background_color" />
                </div>
                <div class="grid gap-2">
                    ...
                    <InputMessage :message="errors.text_color" />
                </div>
            </div>
            ...
            <div class="grid gap-2">
                ...
                />
                <InputMessage :message="errors.brand_font" />
            </div>
            ...
            <div class="grid gap-2">
                ...
                <Textarea
                    ...
                    rows="3"
                />
                <InputMessage :message="errors.brand_voice_notes" />
            </div>
